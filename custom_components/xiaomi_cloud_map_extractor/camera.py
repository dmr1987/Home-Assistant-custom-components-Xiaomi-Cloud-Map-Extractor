...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        ...
        vol.Optional(CONF_BG_IMAGE_ALPHA, default=50): cv.positive_int,
...
class VacuumCamera(Camera):
    ...
    def __init__(self, entity_id: str, host: str, token: str, username: str, password: str, country: str, name: str,
                 ...
                 force_api: str,
                 bg_image_use: bool, bg_image_path: str, bg_image_alpha: int):
        super().__init__()
    ...
    def _handle_map_data(self, map_name: str):
        ...
        map_data, map_stored = self._device.get_map(map_name, self._colors, self._drawables, self._texts,
                                                    ...
                                                    self._bg_image_use, self._bg_image_path, self._bg_image_alpha, store_map_path)
